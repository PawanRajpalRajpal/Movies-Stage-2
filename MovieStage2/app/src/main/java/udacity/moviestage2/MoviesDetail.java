...
public class MoviesDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // }
        ...
        sel_movie_id=moviesData.getMovie_id();//fetch movie id for comparing with database for favourite match
